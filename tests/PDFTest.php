...
class PDFTest extends PHPUnit_Framework_TestCase {
	...
	{
		$this->pdf = new \Inline\PDF\PDF('echo', sys_get_temp_dir());
	}
	...
	/**
	 * @expectedException Inline\PDF\PDFException
	 */
	public function testGeneratePdfThrowsExceptionWhenAnErrorOccured()
	{
		$mock = m::mock('Inline\PDF\PDF[executeCommand]', array('echo', sys_get_temp_dir()));
	...
	{
		$mock = m::mock('Inline\PDF\PDF[executeCommand,removeTmpFiles,getPDFContents]', array('echo', sys_get_temp_dir()));
